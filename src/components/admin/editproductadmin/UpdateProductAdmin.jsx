import style from './updateproductadmin.module.css';
import React from 'react';
import { AppContext } from '../../../App';
import { Link } from 'react-router-dom';
import { addAvatarProduct, updateProduct} from '../../../api/requests';
...
const UpdateProductAdmin = () => { 
    ...
    const onClickBtn = () => {      
        ...
        " id товара определилась: " + context.editProduct.id);         
    ...
    const onAddToServer = async () => { 
        ...
        formDataProduct.append('id', context.editProduct.id);
        ...
        await updateProduct(formDataProduct).then((response)=>{
