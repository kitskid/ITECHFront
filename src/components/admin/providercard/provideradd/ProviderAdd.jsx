import style from './provideradd.module.css';
...
const ProviderAdd = () => { 
    ...
    const { register, handleSubmit, formState: { errors }, watch} = useForm({
        defaultValues: {
            login: context.dataFormProvider.login,  
            email: context.dataFormProvider.email,
            hasPhone: context.dataFormProvider.hasPhone,
            phone: context.dataFormProvider.phone,
            password: context.dataFormProvider.password, 
            userrole: context.dataFormProvider.userrole         
        }
    });
