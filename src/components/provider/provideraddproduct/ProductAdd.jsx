...
const ProductAdd = () => { 
    ...
    React.useEffect(()=>{ 
        ...
        async function axiosCategories () {
            ProductsService.getCategoriesProvider().then((response) =>{
    ...
    const { register, handleSubmit, formState: { errors }} = useForm({
        defaultValues: {
            name: context.dataFormProduct.name,  
            description: context.dataFormProduct.description,
            prov_id: context.dataFormProduct.prov_id,
            price: context.dataFormProduct.price,
            cat_id: context.dataFormProduct.cat_id                  
        }
    });
    ...
    const onClickBtn = (data) => {  
        ...
        console.log(data);        
        navigate('/productaddcard');
                       
    }  
    

    const closeAddProduct =()=>{
        context.setAddProduct(false); 
    ...
    return(       
        ...
        <div className={style.adduser_page}>            
           ...
           <div className={style.form_div}>
                <p className={style.form_p}>Дoбавляем новый товар</p>
                ...
                <form onSubmit={handleSubmit(onClickBtn)} className={style.container_form}>
                    ...
                    <select
                        ...
                        name='prov_id'                    
                    >
                        <option value={localStorage.getItem('ID')}>{localStorage.getItem('LOGIN')}</option>  
                    </select>                    
